...
export async function seedDatabase(isReset: boolean = false) {
  ...
  if (isReset || inventoryCount === 0) {
    await db.insert(inventoryItems).values([
      ...
      { name: 'Avocados', quantity: '8.00', unit: 'pcs', reorderLevel: '15.00', costPerUnit: '1.50', supplierId: supplierFresh.id },
      { name: 'San Marzano Tomatoes', quantity: '45.00', unit: 'kg', reorderLevel: '20.00', costPerUnit: '3.40', supplierId: supplierItalian.id },
      { name: 'Buffalo Mozzarella', quantity: '4.50', unit: 'kg', reorderLevel: '10.00', costPerUnit: '12.00', supplierId: supplierItalian.id },
