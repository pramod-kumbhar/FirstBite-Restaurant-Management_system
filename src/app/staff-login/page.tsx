...
import { ArrowLeft, ChefHat, CircleDollarSign, UserCog, Users, Eye, EyeOff } from 'lucide-react';
...
function StaffLoginForm() {
  ...
  const [role, setRole] = useState(() => {
    ...
    return requested && roleLabels[requested] ? requested : 'manager';
  });
          ...
          <div>
            ...
            <div className="relative">
              <input 
                ...
                className="w-full rounded-xl border border-white/10 bg-slate-900/60 px-4 py-3 pr-11 text-white outline-none focus:border-rose-500/40 transition" 
                placeholder="••••••••" 
                required 
              />
              <button
